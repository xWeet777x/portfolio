...
$.post("http://josemardossantos.com/testes/site2016/site_2016/enviar.php", $("#contactform").serialize(),  function(response) {
...
$(document).scroll(function(){
    ...
    if(docScroll >= boxCntOfset ) {
      ...
      $("#line-1").css('width','82%');// EDIT % YOUR PROGRAMMING SKILL// 
      $("#line-2").css('width','90%');// EDIT % YOUR GRAPHIC DESIGN SKILL// 
      $("#line-3").css('width','72%');// EDIT % YOUR WORDPRESS SKILL// 
      $("#line-4").css('width','50%');// EDIT % YOUR WORDPRESS SKILL// 
    } else {
